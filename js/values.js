...
const ITEMS = [
  ...
  // ════════════ VEHICLES ════════════════════════════════════════
  {
    ...
    demand:"Extraordinary",       dupedDemand:"Solid",    trend:"Rising",
  ...
  },
  {
    ...
    demand:"Solid",       dupedDemand:"Medium",    trend:"Stable",
  ...
  },
  {
    ...
    demand:"High",       dupedDemand:"Solid",    trend:"Stable",
  ...
  },
  {
    ...
    demand:"Medium",       dupedDemand:"Low",    trend:"Stable",
  ...
  },
  {
    ...
    demand:"High",       dupedDemand:null,    trend:"Stable",
    change:"+500,000", dupeChange:"", demandChange:"", trendChange:"",
  ...
  },
  {
    ...
    demand:"Solid",       dupedDemand:null,    trend:"Hyped",
  ...
  },
  {
    ...
    demand:"Solid",       dupedDemand:null,    trend:"Stable",
  ...
  },
  {
    ...
    demand:"Low",       dupedDemand:null,    trend:"Stable",
  ...
  },
  {
    ...
    demand:"Minimal",       dupedDemand:null,    trend:"Stable",
  ...
  },
  {
    ...
    demand:"Medium",       dupedDemand:null,    trend:"Stable",
    change:"", dupeChange:null, demandChange:"", trendChange:"",
  ...
  },
  {
    ...
    value:3000000, duped:null,
    demand:"Average",       dupedDemand:null,    trend:"Stable",
    change:"", dupeChange:null, demandChange:"", trendChange:"",
  ...
  },
  {
    ...
    demand:"Low",       dupedDemand:"Minimal",    trend:"Stable",
    change:"", dupeChange:null, demandChange:"", trendChange:"",
  ...
  },
  {
    ...
    demand:"High",       dupedDemand:"Solid",    trend:"Rising",
  ...
  },
  {
    ...
    value:1500000, duped:null,
    demand:"Minimal",       dupedDemand:null,    trend:"Falling",
      ...
      <div class="card-body">
        ...
        <div class="card-stats">
          <div class="card-stat-row">
            ...
            <span class="stat-val" style="color:#ffd166;font-family:var(--font-mono);font-size:0.8rem;font-weight:700">${fmtValue(item.value)}${changeBadge(item.change)}</span>
          </div>
          <div class="card-stat-row">
            <span class="stat-lbl">${isObtainableLimited(item) ? 'Limited' : 'Duped'}</span>
            ${item.duped!==null
              ? `<span class="stat-val" style="color:${isObtainableLimited(item) ? 'var(--c-limited)' : 'var(--text-dim)'};font-family:var(--font-mono);font-size:0.8rem;font-weight:700">${fmtValue(item.duped)}${changeBadge(item.dupeChange)}</span>`
  ...
  if (item.dupedDemand) {
    demandEl.innerHTML = `
      <div style="display:flex;flex-direction:column;gap:5px;">
        <div><span class="badge-demand ${demandClass(item.demand)}">${item.demand}</span><span class="demand-sub" style="margin-left:5px;">(clean)</span>${prevBadge(item.demandChange)}</div>
        <div><span class="badge-demand ${demandClass(item.dupedDemand)}">${item.dupedDemand}</span><span class="demand-sub" style="margin-left:5px;">(duped)</span></div>
      </div>`;
  } else {
